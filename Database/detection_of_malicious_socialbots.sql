...
--
-- Database: `detection_of_malicious_socialbots`
--
CREATE DATABASE IF NOT EXISTS `detection_of_malicious_socialbots` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detection_of_malicious_socialbots`;
...
('o7x1vhluuypdfmgv7fmv6nohgfn5ub55', 'ZThjYThhNThlZDc3MmJmYTQ2NTcxMzJiYTk2MmNjYWVmZDljMWJkODp7InVzZXJpZCI6MTF9', '2019-12-30 12:27:08.368039'),
...
('um5qmghikjjskyicac0ajswvtqun1zzg', 'eyJ1c2VyaWQiOjR9:1kmGIR:LN9eP9X_nnLOCfoPwjQ5_9EMyR2xK0uIt_m0a9NHyF0', '2020-12-21 13:11:19.014265'),
('z1usj4a1t99eoq8igu9bjnf0xd5wndnd', 'NjRjNzBkMzdmMGI3NDFkNmE3YWI3N2ZhOGVjOWU0NjQzYzcxM2VkMzp7InVzZXJpZCI6M30=', '2020-01-14 12:22:15.337890');
...
(1, 'Kumar', 'Kumar.123@gmail.com', 'Kumar', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(2, 'Raja', 'Raja123@gmail.com', 'Raja', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(3, 'Ashok', 'Ashok.123@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(4, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnatak', 'Bangalore'),
(5, 'tmksmanju', 'tmksmanju13@gmail.com', 'tmksmanju', '9535866270', 'Inida', 'Karnataka', 'Bangalore'),
(6, 'Rajesh', 'Rajesh.123@gmail.com', 'Rajesh', '9535866270', 'Inidia', 'Karnataka', 'Bangalore');
...
(23, 'Kumar', 'The traffic for Ambulance is bad', 'False Positive', '2020-12-07 17:07:39.596087', 'Traffic', 'Better to avoid Traffic'),
(24, 'Kumar', 'Exam system is good for students', 'False Negative', '2020-12-07 17:26:16.550034', 'Exam', 'to know about exam'),
(25, 'Kumar', 'We can find more details in t.co and can view all information.', 'Malicious Bots', '2020-12-07 17:28:15.296717', 'Sexual_assaults', 'to know about sexual assaults'),
(26, 'Manjunath', 'This is excellent invention if vaccine comes to the market', 'False Negative', '2020-12-07 18:42:18.499353', 'Corona_Vaccine', 'Consume all people');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_tweets_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_tweets_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_tweets_model`
--

INSERT INTO `remote_user_tweets_model` (`id`, `tdesc`, `topics`, `sanalysis`, `senderstatus`, `ratings`, `userId_id`, `usefulcounts`, `uses`, `names`, `dislikes`, `uname`) VALUES
(38, 'Bangalore traffic is very bad', '', 'False Positive', 'process', 3, 2, 0, 'Bangalore', 'Traffic', -4, 'Raja'),
(39, 'There is no sexual assaults in Bangalore and it is excellent', '', 'False Negative', 'process', 2, 2, 0, 'Bangalore', 'Sexual_assaults', -2, 'Raja'),
(40, 'Child abuse is one of the big issues in India which will deserve unhappy for all parents.', '', 'se', 'process', 0, 4, 0, 'to discover all Abuses', 'Child Abuse', -1, 'Manjunath'),
(42, 'Covid virus is very dangerous virus and can see more discussion in t.co and get details about this virus.', '', 'Malicious Bots', 'process', 1, 1, 0, 'to know about corona virus', 'Covid19', -1, 'Kumar'),
(43, 'IT is very dangerous virus and can find more details in bit.ly website.', '', 'Malicious Bots', 'process', 1, 1, 0, 'to know about corona symptoms', 'Corona_Symptoms', 0, 'Kumar'),
(46, 'This is dangerous virus', '', 'False Positive', 'process', 0, 1, 0, 'to inform people about this virus', 'Corona_Virus', -1, 'Kumar'),
(47, 'This is very good if vaccine is found for corona virus and see more details in goo.gl and can search more details about this.', '', 'Malicious Bots', 'process', 1, 6, 0, 'to avoid virus infection', 'Corona_Vaccine', 0, 'Rajesh');
